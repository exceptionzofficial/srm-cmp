...
import { FiUsers, FiDollarSign, FiLogOut, FiMenu, FiFileText, FiClipboard, FiPieChart, FiLayers } from 'react-icons/fi';
...
const Layout = () => {
    ...
    const CURRENT_USER_ID = user.employeeId || user.managerId || 'CLUSTER-ADMIN-DEFAULT';
    const userName = user.name || 'Cluster Manager';
