...
const EmployeeForm = () => {
    ...
    const handleResendOTP = async (type) => {
        if (!canResend) return;
        if (type === 'email') await handleSendEmailOTP();
        else await handleSendMobileOTP();
    };
                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                {verification.mobileOtpSent && !verification.mobileVerified && (
                                    <div className="flex flex-col gap-2 mt-2">
                                        ...
                                        <button type="button" onClick={() => handleResendOTP('mobile')} disabled={!canResend} className="text-sm text-blue-600 hover:text-blue-800 self-end">
                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                {verification.emailOtpSent && !verification.emailVerified && (
                                    <div className="flex flex-col gap-2 mt-2">
                                        ...
                                        <button type="button" onClick={() => handleResendOTP('email')} disabled={!canResend} className="text-sm text-blue-600 hover:text-blue-800 self-end">
                                            {canResend ? 'Resend OTP' : `Resend in ${resendTimer}s`}
                                        </button>
                                    </div>
                                )}
